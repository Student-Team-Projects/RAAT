...
data class ServerProfile(
         ...
         */
        var geometry: String = "800x600",
        /**
         * Desktop environment for the VNC server (e.g. Xfce or Lxde)
         */
        var desktopEnv: String = "Lxde",
        /**
         ...
         * See [com.tcs.raat.viewmodel.VncViewModel.preConnect]
         */
